...
export default function ChatPanel({ chat, messages, unreadMarker, contactOnline, hasOlderMessages, loadingOlderMessages, onLoadOlder, onSend, onEdit, onDelete, onFile, onToggle, onClose, onCreateGlpiTicket, onBack, onOpenImage }) {
  ...
  return <section className="chat-panel">
    ...
    {showScrollButton && <button className={`scroll-to-bottom ${replyTo || editingMessage ? 'with-reply' : ''}`} type="button" onClick={scrollToBottom} title="Ir para o fim da conversa" aria-label="Ir para o fim da conversa"><i className="fa-solid fa-chevron-down" /></button>}
