...
async function confirmClear() {
    ...
    try {
        const answer = await terminal.question('Isso apagará todos os dados, exceto os agentes. Digite APAGAR para continuar: ');
...
async function main() {
    ...
    try {
        ...
        console.log(`Limpeza concluída. ${deleted} registro(s) removido(s). A coleção agents foi preservada.`);
    } finally {
